        ...
        return (
            <React.Fragment>
                ...
                <div className='activeJobContainer'>
                    ...
                    <NavLink to="/accountManager/postAJob"><IconButton><Add/></IconButton></NavLink>
                            ...
                            <div className="jobListContainer">
                                {
                                    this.state.jobList.map((item, i) => {
                                        return <MenuItem key={i} onClick={()=>this.callOverlay(i)}>
                                            {item.preliminary && <NavLink to={`/accountManager/postAJob/${item.postId}`}><Button className={classes.isPrimaryBox}>Preliminary</Button></NavLink>}
