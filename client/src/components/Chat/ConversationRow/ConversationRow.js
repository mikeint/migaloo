            ...
            <React.Fragment>
                <div className="chatRow" onClick={this.openChat.bind(this)}>
                    <div className="flexColumn">
                        ...
                        <div><span className="heading">Subject: </span>{this.state.conversation.subjectFirstName+" "+this.state.conversation.subjectLastName}</div>
                        <div><span className="heading">Job Posting: </span>{this.state.conversation.jobPostTitle}</div>
                    </div>
                    <div className="flexColumn">
                        <div><span className="heading">Last Message: </span>{
                            this.state.conversation.messageId==null?'Nothing Yet':
