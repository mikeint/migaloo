                    ...
                    <div className="teamContent"> 
                        <div className="flex">
                            ...
                            <div className="socialItems">
                                <a href="https://www.linkedin.com/in/michael-sansone" target="_blank"><img src={linkedInImg} alt="" /></a>
                        ...
                        <div className="flex">
                            ...
                            <div className="socialItems">
                                <a href="https://www.linkedin.com/in/michaelnasser" target="_blank"><img src={linkedInImg} alt="" /></a>
                        ...
                        <div className="flex">
                            ...
                            <div className="socialItems">
                                <a href="https://www.linkedin.com/in/michael-marcucci" target="_blank"><img src={linkedInImg} alt="" /></a>
